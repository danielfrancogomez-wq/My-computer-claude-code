...
MARCH = [
 ("0:00", "OPEN", "Share the workbook.", [
   ("say", "Hi Eva. Three statements from your March numbers. I'll take them left to right, and tell you what each part means and where its total comes from."),
 ]),

 ("0:10", "INCOME STATEMENT", "Point at the whole left block.", [
   ("say", "First, the Income Statement. It answers one question: did you get richer or poorer in March?"),
 ]),
 ("0:15", "REVENUE", "Point at Revenue, then its total.", [
   ("say", "Revenue is everything that came in and left you better off. Six thousand, one hundred and thirty dollars — your salary, your tutoring, your ETF dividends, and the hundred-dollar Uber Eats gift card. The gift card counts even though no money arrived, because you're a hundred dollars better off."),
 ]),
 ("0:35", "EXPENSES", "Point at Expenses, then its total. Then the gym line, then electricity.", [
   ("say", "Expenses are what it cost you to live. Three thousand and thirty-six dollars."),
   ("say", "Two need explaining. Your gym went on the credit card — you haven't paid for it, but you used it in March. Your electricity bill hasn't even arrived — but you used the power in March. An expense counts when you <em>use</em> the thing, not when you pay for it."),
 ]),
 ("1:00", "NET INCOME", "Point at the green cell.", [
   ("say", "Revenue minus expenses is net income. Three thousand and ninety-four dollars. That's how much better off March made you."),
 ]),

 ("1:10", "BALANCE SHEET", "Move to the middle block.", [
   ("say", "Second, the Balance Sheet. Not the month — a photograph of one day, the 31st of March. Three parts: assets, liabilities, net assets."),
 ]),
 ("1:20", "ASSETS", "Point at Assets, then its total, then the holiday deposit line.", [
   ("say", "Assets are everything you own that has value. Fifty-nine thousand, eight hundred and thirty-one dollars — your ETF, your bank account, your car, your gear, your laptop. Plus the thousand-dollar holiday deposit, because you still own that trip. You just haven't taken it yet."),
 ]),
 ("1:40", "LIABILITIES", "Point at Liabilities, then its total, then the electricity line.", [
   ("say", "Liabilities are everything you owe. Two thousand, eight hundred and seventy-three dollars — your personal loan, your credit card, and that electricity bill. The electricity shows up twice: an expense because you used the power, a liability because you still owe the money."),
 ]),
 ("2:00", "NET ASSETS", "Point at the Net assets box.", [
   ("say", "Net assets is assets minus liabilities. What you own, take away what you owe. Fifty-six thousand, nine hundred and fifty-eight dollars. That's your net worth."),
 ]),

 ("2:10", "CASH FLOW", "Move to the right block. Point at cash in, then cash out.", [
   ("say", "Third, the Cash Flow Statement. Only real money moving in and out of your bank."),
   ("say", "Cash in, six thousand and thirty — a hundred less than revenue, because the gift card was never cash. Cash out, four thousand, two hundred and seventy-eight. The gym and the electricity aren't in it at all, because no money moved."),
 ]),
 ("2:35", "NET CASH FLOW", "Point at the net figure, then the two bank balances.", [
   ("say", "Your bank grew one thousand, seven hundred and fifty-two dollars. Eight thousand at the start, nine thousand seven fifty-two at the end."),
   ("say", "So March made you three thousand better off, but your bank only grew seventeen hundred. Profit and cash are not the same thing."),
 ]),
 ("2:55", "BRIDGE", "Back to your face.", [
   ("say", "That's March. Now April."),
 ]),
]
